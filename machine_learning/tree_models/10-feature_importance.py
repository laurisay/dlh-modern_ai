...
def feature_importance(rf):
    """
    Compute and return the feature importances from a trained random
    forest model.
    ...
    Returns:
        ...
        indices: A NumPy array of feature indices sorted from least to
            most important (ascending order).
    """
